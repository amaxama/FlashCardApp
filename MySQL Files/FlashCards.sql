...
(CardQueueID MEDIUMINT UNSIGNED AUTO_INCREMENT,
CardID MEDIUMINT UNSIGNED,
CardName VARCHAR(30) NOT NULL,
CardChallenge VARCHAR(30) NOT NULL,
CardAnswer VARCHAR(1000) NOT NULL,
PRIMARY KEY(CardQueueID),
UNIQUE KEY(CardID)
);

CREATE TABLE IF NOT EXISTS CardCategoryQueue
(CardQueueID MEDIUMINT UNSIGNED,
CategoryID SMALLINT UNSIGNED,
PRIMARY KEY(CardQueueID, CategoryID),
CONSTRAINT fk_CardCategoryQCardQueueID FOREIGN KEY (CardQueueID) REFERENCES CardQueue(CardQueueID),
